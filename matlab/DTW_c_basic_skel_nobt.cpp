        ...
        {
            {
                ...
                {
                    case 1:
                        P1[m+M*n]=P1[(m-1)+M*(n-1)]+wt[0]; // The subtraction plays a role when there is no change in the consecutive diagonal entries of local distance matrix,
                        break;
                    case 2:
                        P1[m+M*n]=P1[(m-1)+M*n]+wt[1];
                        break;
                        
                    default:
                        P1[m+M*n]=P1[m+M*(n-1)]+wt[2];
                        break;
                }
